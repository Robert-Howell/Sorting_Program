...
layout = [[sg.Text("Enter size of list to sort", font='Lucida, 20'),
           sg.Input(key='-LIST_LENGTH-', font='Lucida, 20', size=(20, 10))],
          [sg.ProgressBar(50, orientation='h', size=(100, 20), border_width=4, key='-PROGRESS_BAR-',
